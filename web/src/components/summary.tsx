		...
		<div className="py-10 max-w-[480px] px-5 mx-auto flex flex-col gap-6">
			<div className="flex items-center justify-between">
				...
				<DialogTrigger asChild>
					{/* asChild indica que o elemento filho que será o trigger, prevenindo que seja criado 2 botões*/}
					<Button size="sm">
			...
			<div className="flex flex-col gap-3">
				...
				<div className="flex items-center justify-between text-xs text-zinc-480">
					<span>
